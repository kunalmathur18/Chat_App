...
//                 <h2 className='text-[25px]'>Welcome back, To <span className='text-[#33dbbf] font-bold '>Let's Chat</span></h2>
//                 <p className='text-[18px] font-bold text-white'>Sign Up</p>
//                 <form action="">
//                     <input type="text" placeholder='Email..' name='email' />
//                     <input type="password" placeholder='Password..' name='password' />
//                     <p className='flex gap-2 items-start'>If new user <span className='text-white underline hover:text-[#9be2c3]'> Click Here</span> to Sign IN</p> 
...
//             <h2 className='text-[25px]'>Welcome back, To <span className='text-[#33dbbf] font-bold '>Let's Chat</span></h2>
//                 <h2>Create an Account , <span className='text-[20px] font-bold text-white'>Sign In</span></h2>
//                 <form action="">
//                     <label htmlFor="file">
...
//                     <input type="text" placeholder='Email..' name='email' />
//                     <input type="password" placeholder='Password..' name='password' />
//                     <p >If user exist <span className='text-white underline hover:text-[#9be2c3]'> Click Here</span> to Sign Up</p> 
